...
public class PersionAdapterView_ex_1 extends BaseAdapter{

    private final Context context;
    private final int layout;
    private final List<PersionModelCustomeView_ex_1> persionsList;

    public PersionAdapterView_ex_1(Context context, int layout, List<PersionModelCustomeView_ex_1> persionsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        PersionModelCustomeView_ex_1 persion = persionsList.get(i);
